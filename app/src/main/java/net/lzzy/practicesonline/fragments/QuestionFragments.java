 ...
 * Description:
 */
public class QuestionFragments extends BaseFragment {
    ...
    public static QuestionFragments newInstance(String questionId, int pos, boolean isCommitted) {
    ...
    protected int getLayoutRes() {
        return R.layout.fragments_question;
    }
